...
import { attachColorPicker } from '$lib/legacy/colorPicker.js'; //
import dragSortModule from '$lib/legacy/dragSort.js'; //
import { wireInpaintButtons } from '$lib/legacy/editor/ai-inpaint.js'; //
import { wireAIModelSelectors } from '$lib/legacy/editor/ai-models.js'; //
import { wireRembgAndSharpen } from '$lib/legacy/editor/ai-rembg.js'; //
import { createApplyImageTool } from '$lib/legacy/editor/ai-tool-runner.js'; //
import { wireAIToolsMisc } from '$lib/legacy/editor/ai-tools-misc.js'; //
import {
  controlsHTML as _controlsHTML,
  layerPanelHTML as _layerPanelHTML,
} from '$lib/legacy/editor/build/controls.js'; //
import {
...
} from '$lib/legacy/editor/build/popups.js'; //
import { buildRightPanel } from '$lib/legacy/editor/build/right-panel.js'; //
import { buildToolbar as _buildToolbar } from '$lib/legacy/editor/build/toolbar.js'; //
import { buildTopbar as _buildTopbar } from '$lib/legacy/editor/build/topbar.js'; //
import {
  attachSpinRepeat as _attachSpinRepeat,
  transformPopupHTML as _transformPopupHTML,
} from '$lib/legacy/editor/build/transform-popup.js'; //
import { canvasCoords as _canvasCoords } from '$lib/legacy/editor/canvas-coords.js'; //
import { wireCanvasEvents } from '$lib/legacy/editor/canvas-events.js'; //
import { createCanvasTransforms } from '$lib/legacy/editor/canvas-transforms.js'; //
import { drawCheckerboard as _drawCheckerboard } from '$lib/legacy/editor/checkerboard.js'; //
import { wireClipboardAndDrop } from '$lib/legacy/editor/clipboard-and-drop.js'; //
import {
  buildMergedMaskCanvas as _buildMergedMaskCanvasImpl,
  buildThumbnail as _buildThumbnailImpl,
} from '$lib/legacy/editor/composite-helpers.js'; //
import { createMoveTool } from '$lib/legacy/editor/tools/move.js';
import { createStrokeTool } from '$lib/legacy/editor/tools/stroke.js';
import { createTransformDragTool } from '$lib/legacy/editor/tools/transform-drag.js';
import { createWandTool } from '$lib/legacy/editor/tools/wand.js';
import {
  gaussianBlur as _gaussianBlur,
  motionBlur as _motionBlur,
  zoomBlur as _zoomBlur,
} from '$lib/legacy/editor/filters/blur.js'; //
import { edgeFeather as _edgeFeather } from '$lib/legacy/editor/filters/edge-feather.js'; //
import { createAdjPopupSystem } from '$lib/legacy/editor/fx/adj-popup.js'; //
import {
  fxFilterToSlider as _fxFilterToSlider,
  layerFilterString as _layerFilterString,
} from '$lib/legacy/editor/fx/filter-string.js'; //
import { drawHistogram as _drawHistogram } from '$lib/legacy/editor/fx/histogram.js'; //
import {
...
} from '$lib/legacy/editor/fx/pixel-pass.js'; //
import {
  layerBodyMask as _layerBodyMaskImpl,
  layerUnionAlpha as _layerUnionAlphaImpl,
  seamMask as _seamMaskImpl,
} from '$lib/legacy/editor/harmonize-masks.js'; //
import { createHistoryPanel } from '$lib/legacy/editor/history-panel.js'; //
import { wireKeyboardShortcuts } from '$lib/legacy/editor/keyboard-shortcuts.js'; //
import {
  ...
  relTime as _relTime,
} from '$lib/legacy/editor/layer-helpers.js'; //
import { createLayerPanelRenderer } from '$lib/legacy/editor/layer-panel.js'; //
import {
  applyInpaintFeather as _applyInpaintFeather,
  dilateMask as _dilateMask,
} from '$lib/legacy/editor/mask-utils.js'; //
import { createShortcutsPopover } from '$lib/legacy/editor/shortcuts-popover.js'; //
import { wireSliderUx } from '$lib/legacy/editor/slider-ux.js'; //
import {
  computeSnap as _computeSnapImpl,
  cursorForHandle as _cursorForHandle,
} from '$lib/legacy/editor/snap.js'; //
import { state } from '$lib/legacy/editor/state.js'; //
import { createStrokePipeline } from '$lib/legacy/editor/stroke-pipeline.js'; //
import { wireStrokeToolSliders } from '$lib/legacy/editor/stroke-tool-sliders.js'; //
import { createCloneTool } from '$lib/legacy/editor/tools/clone.js'; //
import { createCropTool } from '$lib/legacy/editor/tools/crop.js'; //
import { floodFillMask as _floodFillMask } from '$lib/legacy/editor/tools/flood-fill.js'; //
import { createLassoTool } from '$lib/legacy/editor/tools/lasso.js'; //
import {
  drawHandles as _drawTransformHandlesImpl,
  getHandleAt as _getTransformHandleImpl,
  syncOverlay as _syncTransformOverlayImpl,
} from '$lib/legacy/editor/tools/transform-handles.js';
import { createTransformSession } from '$lib/legacy/editor/tools/transform-session.js';
import { wireImport } from '$lib/legacy/editor/wire-import.js';
import { wireInpaintControls } from '$lib/legacy/editor/wire-inpaint-controls.js';
import { wireMergeButtons } from '$lib/legacy/editor/wire-merge-buttons.js';
import { wireSelectionControls } from '$lib/legacy/editor/wire-selection-controls.js';
import { closeOtherTopbarMenus as _closeOtherTopbarMenus, wireTopbar } from '$lib/legacy/editor/wire-topbar.js';
import { wireTopbarMenus } from '$lib/legacy/editor/wire-topbar-menus.js';
import { wireTopbarOverflow } from '$lib/legacy/editor/wire-topbar-overflow.js';
