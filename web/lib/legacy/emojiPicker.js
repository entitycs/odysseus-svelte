...
const EMOJI_GROUPS = [
  {
    ...
    items: [
      [
        ...
        'grin',
        I(
          '<circle cx="12" cy="12" r="10"/><path d="M7 14 C 7 18, 17 18, 17 14 Z"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/>',
        ),
      ],
      [
        '♡',
      ...
      [
        ...
        'sparkle',
        I(
          '<polygon points="12 2 14 10 22 12 14 14 12 22 10 14 2 12 10 10" fill="currentColor" stroke="none"/>',
        ),
      ],
      [
        '☽',
        'moon',
        I('<path d="M21 12.8A9 9 0 1 1 11.2 3 7 7 0 0 0 21 12.8z"/>'),
      ],
    ],
  },
  {
    ...
    items: [
      ...
      [
        '●',
        'dot',
        I('<circle cx="12" cy="12" r="6" fill="currentColor" stroke="none"/>'),
      ],
      ...
      [
        ...
        'dagger',
        I(
          '<line x1="12" y1="4" x2="12" y2="20"/><line x1="8" y1="8" x2="16" y2="8"/>',
        ),
      ],
    ],
  },
  {
    ...
    items: [
      ...
      [
        ...
        'arrow-r-dbl',
        I(
          '<polyline points="10 5 17 12 10 19"/><polyline points="6 5 13 12 6 19"/>',
        ),
      ],
      [
        '⇐',
        'arrow-l-dbl',
        I(
          '<polyline points="14 5 7 12 14 19"/><polyline points="18 5 11 12 18 19"/>',
        ),
      ],
    ],
  },
  {
    ...
    items: [
      [
        ...
        'plus-minus',
        I(
          '<line x1="4" y1="10" x2="20" y2="10"/><line x1="12" y1="2" x2="12" y2="18"/><line x1="4" y1="20" x2="20" y2="20"/>',
        ),
      ],
      [
        '×',
      ...
      [
        ...
        'divide',
        I(
          '<circle cx="12" cy="6" r="1.5" fill="currentColor" stroke="none"/><line x1="5" y1="12" x2="19" y2="12"/><circle cx="12" cy="18" r="1.5" fill="currentColor" stroke="none"/>',
        ),
      ],
      [
        '≈',
        'approx',
        I(
          '<path d="M4 9 C 6 6, 8 12, 10 9 S 14 6, 16 9 S 20 12, 22 9"/><path d="M4 15 C 6 12, 8 18, 10 15 S 14 12, 16 15 S 20 18, 22 15"/>',
        ),
      ],
      [
        '≠',
        'not-equal',
        I(
          '<line x1="5" y1="9" x2="19" y2="9"/><line x1="5" y1="15" x2="19" y2="15"/><line x1="16" y1="5" x2="8" y2="19"/>',
        ),
      ],
      [
        '≤',
        'lte',
        I(
          '<polyline points="17 5 7 11 17 17"/><line x1="7" y1="20" x2="17" y2="20"/>',
        ),
      ],
      [
        '≥',
        'gte',
        I(
          '<polyline points="7 5 17 11 7 17"/><line x1="7" y1="20" x2="17" y2="20"/>',
        ),
      ],
      [
        '∞',
      ...
      [
        ...
        'pi',
        I(
          '<line x1="4" y1="8" x2="20" y2="8"/><line x1="9" y1="8" x2="9" y2="20"/><line x1="15" y1="8" x2="15" y2="20"/>',
        ),
      ],
      ...
      [
        '§',
        'section',
        I('<path d="M14 6 a4 3 0 1 0 -4 4 q-3 0 -3 3 t3 3 q3 0 3 -3"/>'),
      ],
      [
        '¶',
        'pilcrow',
        I(
          '<path d="M16 4 H 9 a4 4 0 0 0 0 8 H 12 V 20"/><line x1="16" y1="4" x2="16" y2="20"/>',
        ),
      ],
      [
        '•',
        'bullet',
        I('<circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/>'),
      ],
      [
        '…',
        'ellipsis',
      ...
      [
        ...
        'quote-l',
        I(
          '<polyline points="12 5 6 12 12 19"/><polyline points="18 5 12 12 18 19"/>',
        ),
      ],
      [
        '»',
        'quote-r',
        I(
          '<polyline points="6 5 12 12 6 19"/><polyline points="12 5 18 12 12 19"/>',
        ),
      ],
      [
        '"',
        'quote-dbl',
        I(
          '<line x1="8" y1="5" x2="8" y2="11"/><line x1="11" y1="5" x2="11" y2="11"/><line x1="13" y1="5" x2="13" y2="11"/><line x1="16" y1="5" x2="16" y2="11"/>',
        ),
      ],
    ],
  },
  {
    ...
    items: [
      [
        ...
        'euro',
        I(
          '<text x="12" y="16" font-size="16" text-anchor="middle" fill="currentColor" stroke="none">€</text>',
        ),
      ],
      [
        '£',
      ...
      [
        ...
        'per-mille',
        I(
          '<text x="12" y="16" font-size="13" text-anchor="middle" fill="currentColor" stroke="none">‰</text>',
        ),
      ],
      [
        '№',
        'number',
        I(
          '<text x="12" y="16" font-size="12" text-anchor="middle" fill="currentColor" stroke="none">№</text>',
        ),
      ],
    ],
  },
...
export function createEmojiButton(target) {
  ...
  btn.addEventListener('click', (e) => {
    ...
    e.stopPropagation();
    const el =
      typeof target === 'function' ? target() : document.getElementById(target);
    if (!el) return;
    togglePicker(btn, el);
  });
  return btn;
  ...
  function render(filter = '') {
    ...
    for (const group of EMOJI_GROUPS) {
      const filtered = f
        ? group.items.filter(
            (item) =>
              item[1].toLowerCase().includes(f) || item[0].includes(filter),
          )
        : group.items;
